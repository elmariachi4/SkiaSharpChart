...
namespace SkSharpChart.Droid
{
    ...
    public class SkiaChart
    {
        ...
        public IEnumerable<Decimal> Gains { get; set; }

        public List<decimal> GainsList => new List<decimal>(Gains);

        public IEnumerable<DateTime> Dates { get; set; }

        public IEnumerable<Tuple<Decimal, PointColor>> Values { get; set; }

        //TODO: very bad
        public List<DateTime> DatesList => new List<DateTime>(Dates);

        public List<Tuple<Decimal, PointColor>> ValuesList => new List<Tuple<Decimal, PointColor>>(Values);
